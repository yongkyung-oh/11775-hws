...
if __name__ == '__main__':
    ...
    if data == 'train':
        ...
        print ('  SVM prediction for event {} !'.format(target_event))
        print ('  SVM prediction accuracy {}'.format(predict_accuracy))
        print ('  SVM prediction precision {}'.format(predict_precision))  
        
    elif data == 'train_val':
        target_event = model_file.split('.')[1]
        print ('  SVM prediction for event {} !'.format(target_event))
        print ('  SVM prediction for test file saved')
