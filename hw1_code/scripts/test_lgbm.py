...
if __name__ == '__main__':
    ...
    print 'LGBM prediction for event %s !' % (target_event)
    print 'LGBM prediction accuracy %f' % (predict_accuracy)
    print 'LGBM prediction precision %f' % (predict_precision)
