...
if __name__ == '__main__':
    ...
    # Load the svm model
    svm = cPickle.load(open(model_file, 'r'))
    ...
    #y_pred_proba = svm.decision_function(X_df)
    ...
    print 'SVM prediction for event %s !' % (target_event)
    print 'SVM prediction accuracy %f' % (predict_accuracy)
    print 'SVM prediction precision %f' % (predict_precision)
